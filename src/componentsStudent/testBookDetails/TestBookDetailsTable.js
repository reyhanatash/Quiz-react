...
export default function EnhancedTable(props) {
  ...
  if (props.newdata) {
    props.newdata.forEach(data => {
      rows.push({
        id: data.fkTestBookChapter,
        name: data.testBookChapterName,
        numTest: data.numTest,
        countReview: data.review,
        countDontReview: data.dontReviw,
        countSkip: data.skip,
        countNotSee: data.notSee,
      });
    });
  }
  // Toltip Button
  ...
  const headCells = [
    ...
    { id: 'id', numeric: false, label: 'نام فصل' },
  ];
    ...
    <div className={classes.root}>
      <Paper className={classes.paper}>
        ...
        <div className={classes.tableWrapper}>
          <Table
            className={classes.table + ' table-testBookDetails-student'}
                    ...
                    >
                      ...
                      <TableCell className="py-1">
                        ...
                        >
                          <IconButton
                            aria-label="edit"
                            onClick={() => props.goToStudyPage(row)}
                          >
