    ...
    <div className={classes.root}>
      <Paper className={classes.paper}>
        ...
        <div className={classes.tableWrapper}>
          <Tooltip title={<span>افزودن طراح جدید</span>}>
            <Button
              outline
              color="white"
              onClick={props.toggleModal}
              className="my-3 mr-4 add-book-btn btn-floating bg-white"
            >
              <MdAdd />
            </Button>
          </Tooltip>
                    ...
                    >
                      ...
                      <TableCell className="py-1">
                        ...
                        <Tooltip
                          className="table-icon-info"
                          title={
                            <span style={{ fontSize: '12px' }}>ویرایش</span>
                          }
                        >
                          <IconButton
                            aria-label="Go to Test"
                            onClick={() =>
                              // props.openQuizModal(row.name, row.id, 2)
                              props.toggleModalEdit(row)
                            }
                          >
                            <EditIcon className={classes.actions3} />
                          </IconButton>
                        </Tooltip>
                        {/* <Tooltip
                      ...
                      >
                        ...
                        <Switch
                          ...
                          onChange={() =>
                            props.ChangeActiveTeacher(row.id, !row.isActive)
                          }
                          value="checkedB"
                          color="primary"
